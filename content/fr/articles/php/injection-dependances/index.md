...
Tu noteras que je n'ai pas encore écrit le constructeur de la classe `Person`.
...
L'injection de dépendances, c'est précisément ça. Si une classe a besoin d'une
