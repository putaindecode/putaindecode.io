...
export default class Homepage extends Component {
  ...
  render() {
    const { isLoading, head, body } = this.props;
          ...
          <div className="r-Grid r-Grid--alignCenter">
            ...
            >
              <div className="putainde-Title putainde-Title--home">
                <h2 className="putainde-Title-text">{i18n.howThisWorks}</h2>
              </div>
        ...
        {locale === "fr" && (
          <div className={classes.podcast}>
            <div className={classes.podcastTitle}>
              ...
              <a className={classes.podcastLink} href={i18n.soundcloud}>
                {"SoundCloud"}
              </a>
              {" ou "}
              <a className={classes.podcastLink} href={i18n.itunes}>
                {"iTunes"}
              </a>
            </div>
